...
namespace MvcCreditApp
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionStringCredit = builder.Configuration.GetConnectionString("CreditContext") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
            ...
            builder.Services.AddDbContext<CreditContext>(options =>
                options.UseSqlServer(connectionStringCredit));
